...
namespace Console_Table
{
    public class ConsoleTable
    {
        ...
        public ConsoleTableOptions Options {
            get; protected set;
        }
        ...
        public void Write(Format format = Console_Table.Format.Default)
        {
            switch (format)
            {
                case Console_Table.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Console_Table.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Console_Table.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Console_Table.Format.Minimal:
